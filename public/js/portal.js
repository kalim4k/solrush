/* Everything CrazyGames, kept in one file.
   ...
   The same build serves two places. On your own domain the game is its own
...
/* Fetched on demand rather than sitting in the page as a tag, so a visitor to
   your own domain never downloads it and never gets touched by it. */
...
/* ---------- their ads ----------
   ...
   Nothing calls this today: monetisation is switched off in app.js. It stays
   because it is the portal's OWN ad slot, not a third-party tag — it can only
   ever fire inside their frame, on their inventory, and turning it on later is
